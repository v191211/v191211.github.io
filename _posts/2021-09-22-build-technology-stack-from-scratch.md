...
说到后台技术栈，脑海中是不是浮现的是这样一幅图？ [^1]

![图 1]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_1.png)
...
![图2 后台技术栈结构]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_2.png)
...
![图 3]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_3.png)
...
![图 4，ELK 流程图]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_4.png)

对于有实时计算的需求，可以使用 Flume + Kafka + Storm + MySQL 方案，一 般架构如图 5 所示：

![图 5，实时分析系统架构图]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_5.png)
...
![图 6，监控系统分布]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_6.png)
...
![图 7，Prometheus 架构图s]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_7.png)
...
![图 8，流程图]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_8.png)
...
![图 9，机器管理软件对比]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_9.png)
...
![图 10，后台技术架构]({{ site.url }}/assets/images/posts/build_technology_stack_from_scratch_10.png)
...
[^1]: [从零搭建创业公司后台技术栈](https://mp.weixin.qq.com/s/sDzpa0BhkwvXuapPxZ7fug){:target="_blank"}
